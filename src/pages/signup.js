...
<div className='register-looking-for' >
    ...
    <select>
        ...
        <option>hook ups</option>
        <option>a fling</option>
    </select>
</div>
...
<div><p>from</p></div>
        ...
        <div className='register-profile'>
            ...
            <input id='register-pic' type='file' accept='image/*'  />
        </div>
        <button>done</button>
    </div>
        </div>
